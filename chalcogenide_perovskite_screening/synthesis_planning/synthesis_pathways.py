...
from chalcogenide_perovskite_screening.synthesis_planning.materials_entries import getOrigStableEntriesList
# from myResearch.getOrigStableEntriesList import getOrigStableEntriesList
from chalcogenide_perovskite_screening.synthesis_planning.reactions import get_possible_reactions, Reaction
...
class SynthesisPathways():
    ...
    def turn_to_csv(self, filename):
        ...
        if not isinstance(filename, str):
            directory = str(SYNTHESIS_DATA_DIR / "results_files")
